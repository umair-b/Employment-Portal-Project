...
namespace StudentEmployementPortal.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(DefineRole.Role_Approver).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(DefineRole.Role_Approver)).GetAwaiter().GetResult();
